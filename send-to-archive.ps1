...
$destinationRoot = "C:\Users\Admin\OneDrive\40-archive\44-redundant-copies-and-zips\The KPI Hub"
...
foreach ($path in $Paths) {
    ...
    Write-Host "Moved to archive: $path -> $resolvedTarget" -ForegroundColor Green
}
