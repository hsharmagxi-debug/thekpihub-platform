...
$destinationRoot = "C:\Users\Admin\OneDrive\10-projects\11-The KPI Hub\production-fixes"
...
foreach ($path in $Paths) {
    ...
    Write-Host "Moved to production-fixes: $path -> $resolvedTarget" -ForegroundColor Green
}
