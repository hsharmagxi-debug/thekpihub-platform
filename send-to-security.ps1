...
$destinationRoot = "C:\Users\Admin\OneDrive\20-areas\22-security-and-access\The KPI Hub"
...
foreach ($path in $Paths) {
    ...
    Write-Host "Moved to security: $path -> $resolvedTarget" -ForegroundColor Green
}
