...
$destinationRoot = "C:\Users\Admin\OneDrive\10-projects\11-The KPI Hub\website-source"
...
foreach ($path in $Paths) {
    ...
    Write-Host "Moved to website-source: $path -> $resolvedTarget" -ForegroundColor Green
}
