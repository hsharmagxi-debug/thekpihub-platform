...
$destinationRoot = "C:\Users\Admin\OneDrive\10-projects\11-The KPI Hub\screenshots-reference"
...
foreach ($path in $Paths) {
    ...
    Write-Host "Moved to screenshots-reference: $path -> $resolvedTarget" -ForegroundColor Green
}
